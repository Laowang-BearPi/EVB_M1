package com.mcz.smoke_appproject.app.utils;
...
import static com.mcz.smoke_appproject.app.utils.Config.SELFCERTPATH;
import static com.mcz.smoke_appproject.app.utils.Config.SELFCERTPWD;
import static com.mcz.smoke_appproject.app.utils.Config.TRUSTCAPATH;
import static com.mcz.smoke_appproject.app.utils.Config.TRUSTCAPWD;
...
//命令下发
    public static String Comened_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String deviceId,String Switch)
        ...
        params.add(new BasicNameValuePair("serviceId", "Smoke"));
...
//删除直连设备
    ...
    public static String UPDATE_DEVICEID(Context mContext, String serverurl,String app_key,String accessToken,String name)
        ...
        params.add(new BasicNameValuePair("model", "Smoke"));
